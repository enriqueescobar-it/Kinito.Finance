def NameList50():
        return ["ASIANPAINT.NS", "ADANIPORTS.NS", "AXISBANK.NS",
        "BAJAJ-AUTO.NS", "BAJFINANCE.NS", "BAJAJFINSV.NS", "BPCL.NS", "BHARTIARTL.NS",
        "CIPLA.NS", "COALINDIA.NS", "DRREDDY.NS", "EICHERMOT.NS", "GAIL.NS",
        "GRASIM.NS", "HCLTECH.NS", "HDFCBANK.NS", "HEROMOTOCO.NS",
        "HINDALCO.NS", "HINDPETRO.NS", "HINDUNILVR.NS", "HDFC.NS",
        "ITC.NS", "INFRATEL.NS", "ICICIBANK.NS", "IBULHSGFIN.NS", "IOC.NS", "INDUSINDBK.NS", "INFY.NS",
...
def FAGMAlist():
        return ["AMZN", "AAPL", "CSCO", "IBM", "FB", "MSFT"]

def FAGMATestlist():
        return ["AAPL", "MSFT", "CSCO", "AMZN", "INTC"]
