...
yahooStockOption: YahooStockOption = YahooStockOption('GOOGL')#'ESTC')XWEB DDOG BEKE GBTC GNDP.V IHI
...
# MDLZ. MDB+6 MAA. MTUM+ NWC.TO.
# NEE+ NEM+ NET+2 NKE+ NSP NEAR NFLX+++ NIO+4 NLY. NLOK NNDM NPI NOBL+ NVEI.TO NVDA+5 NOW+4 NRZ-
# O+ OTEX OHI O- NWC.TO. OKTA+++++ OKE++ MC-
# PM- PANW PFE+ PINS PG+ PGX PEP+ PLAN PLTR PPL.TO+ PBA+ PBW+3.5 PRU- PVD PTON PAWZ PSEC PYPL+3 PCTY+++ PKI.TO PHO PHM++ POW.TO.
# PAAS+++ PAYC+6 PBH. PDD+3 PNC+ PTGX+ PIODX+ PKI.TO+ PINS+ PNR+
