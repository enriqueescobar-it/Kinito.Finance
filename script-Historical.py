...
yahooStockOption: YahooStockOption = YahooStockOption('BEP')#'ESTC')XWEB DDOG BEKE GBTC GNDP.V IHI
...
# # passive TSX
# BCE.TO MG.TO SIS.TO IFC.TO AP-UN.TO
# # easy portfolio
# 10% -> VAB VGV
# 90% -> 25% VFV XUS 20% HXQ XQQ 5-10% XEC 25% XRE XDV 20% ARKK ARKG
# AAPL+3 ABBV+ AAOI ADBE+3 ABR+ ABT++ ABX.TO&GOLD ACES ADC+ ADP+ AGNC AKAM AMGN AMD+20 AM. AMP+1.5 AMT+ AMZN+3 ANTM+ AQN+ AQN.TO+
...
# CNQ.TO. CSIQ+1.5 CELH+ CM+ CMI+1.5 CPX.TO+1.5 CVA. CLH+ COLL. COUP+5 CRM+1.5 CHTR+2 CDW+2 CCI+
...
# EMR+ ENB&TO. ESS ESTC+ ESPO EMA.TO EL+1.5 ETSY+10 ENGH.TO+ ENPH+ EEM EQB.TO+ ELY+ ESS- EPD+ EB. ENPH+25 ET. EBAY+
# F FD.TO FF.TO FFMG FENY FIE FIS+ FIVG FSLR FSLY++ FSRNX FSZ FTS+ FTS.TO+ FOOD.TO FZILX FZROX FVRR FXAIX FEYE. FRT. FCEL.
...
# IBUY IWFH INTC+ INTU+2 IPO+2 IIVI IIPR+++++ INVH+ IVAC IGV+ IBM. IRM+ IT+ IPFF. IWY++ ICLN++ IVR. IEP+
# JKS+2 JD+ JNJ+ JPM+ JNUG. JNPR.
# KEY K KXS.TO KDP KL KL.TO KO! KR KMI. K.TO++ KXS.TO+ KHC.
# LB.TO LMT+ LNT+ LMND LOW++ LSPD&TO+2.5 LVGO LOGI+ LAND+ LMND+ LULU+3 LUV.
# M MA+2 MAIN MELI+10 MFI.TO MO. MU+3 MCD+ MGM MPW+1.5 MRK+ MARA MRNA+4 MRVL MSFT+2.5 MWK MDY MRU.TO+ MSCI+ NXST MFC.TO. MXIM+
# MDLZ. MDB+6 MAA. MTUM+ NWC.TO. MGNI+
# NEE+ NEM+ NET+2 NKE+ NSP NEAR NFLX+++ NIO+4 NLY. NLOK NNDM NPI NOBL+ NVEI.TO NVDA+5 NOW+4 NRZ- NUSI+
...
# QCOM+2 QQC-f QQQ+1.5 QRVO QSR.TO+ QQQJ++ QRS.TO
# RBA RCI+ RCI.B.TO+ REAL.TO RCL.S REGI ROK+ RUN RY+ RY.TO+ RIOT RHS RNG+9 ROKU+ RF+ RNW.TO++ ROP+ RSG++ RTX.
# SU. SU.TO. SIS.TO+ SNA SBUX+ SHOP&TO+25 SPLK SPYD SJR.B SJR-B.TO SLV+ SNAP SNOW+ SPOT SOXL SRU.UN.TO. SPG SAP
# SPNS+2 SNPS+3 STOR+ STAG SEDG+ SJR-B.TO SOY.TO. SYK++ STX+ SQ+8 SFTBY+2 SAVA. SMOG+2 SE+7.5 SCHA+
# T&TO+ TD TTD+15 TDOC+10 TEC.TO TAL+ TEAM+5 TFII+ TFII.TO+ TGT- TRMB TSLA+++ TRP TRP.TO TTD+15 TOU.TO TROW TWLO+6 TWST+
