...
# IBUY+2.5 IWFH+1.25 INTC+ INTU+2 IPO+2 IIVI+2.5 IIPR+12 INVH+ IVAC+0.8 IGV+2 IBM+.5 IRM+ IT+ IPFF. IYW+2 IWY+1.5 ICLN++
# IVR. IEP+ IXN+2
...
# RBA RCI+ RCI.B.TO+ REAL.TO RCL.S REGI ROK+ RUN RY+ RY.TO+ RYT+1.5 RIOT RHS RNG+9 ROKU+ RF+ RNW.TO++ ROP+ RSG++ RTX.
