...
# BYND+1.4 BAM-A.TO+ BMO.TO. BTI+0.4 BMY+0.5 BGS+0.6 BAND+6.2 BP+0.5 BX+1.8 BMBL+1.0 BLNK+1.1
...
# CSH-UN.TO+0.5 CNQ&TO+0.8 CSIQ+1.0 CRUS+1.1 CURI+1.2 CWEN+1.4
# DASH+0.7 DCBO.TO DND.TO DHIL+0.6 DLHC DKNG+5.6 DDOG+1.7 DOC+0.7 DOL.TO+ DND.TO+ DIS+ DHR+++ DTE+ DE++ DOCU+3.8 DVN.
# DAL. DBX+0.6 DLR+ DTE+ DOC.V+2 DYNF+1.0 DLR+1.0
# EMR+1.0 ENB&TO. ESTC+1.2 ESPO+1.6 EMA.TO+0.8 EMQQ+2.0 ED+0.6 EL+1.5 ETSY+11.9 ENGH.TO+1.2 ENPH+30.6 EEM+0.9 EQB.TO+1.3 ELY+1.5 ESS+0.7
...
# FTEC+1.8 FAST+1.5 FB+1.5 FRC+ FRO. FROG. FRT. FCEL. FCX+3
...
# PTON+4.4 PTGX+1.1 PYPL+4.1 PKI.TO+1.2 PLUG+7.9 PNW+0.7
...
# U+1.5 UNM+0.5 UNP+1.5 UPST+3.9 UPWK+1.2 UNM+0.5 UDN+0.5 UL+0.7
...
# XEI.TO. XIT.TO+1.7 XBC.TO XOM. XWEB+ XLC+ XLK+2 XBC.V+++ XT+1.4 XTC.TO. ZS++ XBUY+1.5
# YCBD+0.5
...
a_ticker = 'SAP' #'ESTC')XWEB DDOG BEKE GBTC IHI GC=F JPY=X ^TNX BTC-USD BTCC-B.TO
