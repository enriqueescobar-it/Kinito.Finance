...
yahooStockOption: YahooStockOption = YahooStockOption('TSN')#'ESTC')XWEB DDOG BEKE GBTC GNDP.V
# DividendYield [2%, 4%]
...
# EMR+ ENB- ENB.TO- ESS ESTC+ ESPO EMA.TO ET ETSY+ ENGH.TO+ ENPH+ EEM EQB.TO+ ELY+ ESS-
...
# NEE+ NEM+ NET NKE NSP NEAR NFLX NIO++ NLY NLOK NNDM NPI NOBL+ NVEI.TO NVDA+++++ NOW+
...
# T+ T.TO+ TD TDOC+ TEC.TO TAL+ TEAM TFII+ TFII.TO+ TGT- TRMB TSLA+++ TRP TRP.TO TTD+++++ TOU.TO TROW TWLO++++ TXN TWST+ TVE.TO. TPB+++ TSN-
# U UNM UNP UPWK UNM-
