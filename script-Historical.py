...
# CAG CCA CCA.TO. CGNX CGO CGO.TO. CHD CL- CLX CM CNI CSX CMCSA COST CP CRM CSCO DCBO.TO DND.TO
# EMR+ ENB ESS ESTC F FD.TO FF.TO FFMG FIE FROG FSRNX FSZ FTS FOOD.TO FZILX FZROX GM GIS GLD GMF GNW GRWG GILD
# HD HLT HQU HZU IBM INTC IPO IIVI IBM IRM IT JKS JNJ+ JPM+ JNUG JNPR KEY K KXS.TO KDP KL KO- KR
