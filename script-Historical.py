...
# AMD+21.7 AM+0.3 AMP+1.5 AMT+1.5 AMAT+3.2 A+1.8 AA+0.5 API+1.0 AMCX+0.6
...
# BA BCE BCE.TO. BNS BPY BABA+1.7 BIDU- BBBY BNTX BRK-B+ BRTXQ BYND BNS.TO. BIP+ BEP+2.5 BIP-UN.TO+1.5 BZUN+ BILI++ BEP+
...
# CSH-UN.TO+0.5 CNQ&TO+0.8 CSIQ+1.0
# DCBO.TO DND.TO DLHC DKNG+ DDOG+ DOL.TO+ DND.TO+ DIS+ DHR+++ DTE+ DE++ DOCU+3 DVN. DAL. DLR+ DTE+ DOC.V+2 DYNF+1.0 DLR+1.0
# EMR+ ENB&TO. ESS ESTC+ ESPO EMA.TO EMQQ+2 EL+1.5 ETSY+10 ENGH.TO+ ENPH+ EEM EQB.TO+ ELY+ ESS- EPD+ EB. ENPH+25 ET.
# EBAY+ ET+0.9
# F+0.6 FD.TO FF.TO FDN+1.5 FFMG FENY FIE FIS+ FIVG+ FSR+2.4 FSLR FSLY++ FSRNX FSZ FTS+ FTS.TO+ FOOD.TO FZILX FZROX FVRR FXAIX FEYE.
...
# HD+ HLT HQU HZU HEO.V HII. HLF.TO. HUBS+3 HRL. HTA. HIW. HACK++ HRL. HXQ.TO+1.6 HCLN.TO+0.9 HERO.TO+1.5 HASI+2.3
# IBUY+2.5 IWFH+1.25 INTC+ INE.TO+1.3 INTU+2 IPO+2 IIVI+2.5 IIPR+12 INVH+ IVAC+0.8 IGV+2 IBM+0.8 IRM+ IT+ IPFF. IYW+2 IWY+1.5
# ICLN++ IVR. IEP+ IXN+2
...
# M+0.5 MA+2 MAIN+0.8 MET+0.8 MELI+10 MFI.TO+0.6 MO+0.5 MU+3 MCD+ MGM MRVL MSFT+2.5 MWK+2 MDY+ MRU.TO+ MSCI+ MFC.TO+0.8 MXIM+
# MDLZ. MDB+6 MAA. MTUM+ NWC.TO. MGNI+ MLPX+0.5 MPW+1.5 MRK+ MARA+0.5 MRNA+4 MFC.TO+0.8 MG.TO+ MOGO+1.8 MSTR+3.3 MAC+0.1 MC-
# MPLX+0.7
# NEE+1.5 NEM+1.2 NET+3.5 NKE+1.2 NSP+1.9 NEAR+0.5 NFLX+2.9 NIO+6.2 NLY+0.7 NLOK NNDM NPI NOBL+ NVEI.TO NVDA+5 NOW+4 NRZ- NUSI+ NXST+1.5 NWC.TO.
...
# PTON+4.4 PTGX+1.1 PYPL+4.1 PKI.TO+1.2 PLUG+12.9
...
# SU&TO. SEM+1.6 SIS.TO+ SNA SBUX+ SHOP&TO+25 SPLK SPYD SJR.B SJR-B.TO SLV+0.8 SNAP+1.6 SNOW+ SPOT SOXL SRU.UN.TO. SPG SAP SPGI+1.9
...
# TWST+7.9 TXN+1.8 TCL-A.TO+0.7 TLRY+0.8
...
# W+4.2 WCN&TO+1.2 WELL.TO+225.9 WEED.TO+7.5 WM+1.1 WMT+1.1 WORK+0.8 WPC+0.8 WPM+1.5 WBA+0.3 WKHS+1.7
