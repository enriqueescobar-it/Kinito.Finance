...
# AAPL ABBV ABR+ ABX.TO ACES AGNC AMGN AMD AMP AMT AMZN AQN ASAN ARKF ARKK AVAV AVB AYX AZN
# BA BCE BPY BABA BBBY BNTX BRK-B BRKA BRKB BRTXQ BYND
# CAG CCA CCA.TO. CGNX CGO CGO.TO. CHD CL- CLX CM CNI CSX CMCSA COST CP CRM CSCO DCBO.TO DND.TO CU.TO
# EMR+ ENB ESS ESTC F FD.TO FF.TO FFMG FIE FROG FSRNX FSZ FTS FOOD.TO FZILX FZROX GM GIS GLD GMF GNW GRWG GILD
# HD HLT HQU HZU IBM INTC IPO IIVI IBM IRM IT JKS JNJ+ JPM+ JNUG JNPR KEY K KXS.TO KDP KL KO- KR KMI
# LB.TO LMT LMND LOW+ LSPD LVGO
# M MA MAIN MELI MO MU MCD- MPW MRNA MRVL MSFT MWK NET NKE NSP  NFLX NLY NLOK NPI NVEI.TO O+ OTEX
# PM PANW PFE PEP PLAN PLTR PPL PRU PTON PAWZ PSEC PYPL
# QCOM QQC-f QQQ RBA RCI RCI.B REAL.TO REGI ROK RUN RY SU SU.TO SNA SBUX SHOP SPYD SJR.B SLV SNOW SPOT SOXL SRU.UN.TO.
# T+ TD TDOC TEC.TO TEAM TFII TFII.TO+ TGT- TRMB TTD TROW TWLO TXN U UNM UNP UPWK
# VDC VFC VFV VGT VMW VNR VPL VPU VTSAX VYM VYMI VZ V
# WCN WCN.TO+ WELL WMT- WORK XEI XIT XBC.TO YCBD ZG ZM ZQQ ZS ZWB
