...
# BA BCE BCE.TO. BNS BPY BABA+1.7 BIDU- BBBY BNTX BRK-B+ BRTXQ BYND BNS.TO. BIP+1.4 BEP+2.5 BIP-UN.TO+1.5 BZUN+ BILI++ BEP+
...
# CDNS+3.5 CNQ.TO. CSIQ+1.5 CELH+ CM+ CMI+1.5 CPX.TO+1.5 CVA. CLH+ COLL. COUP+5 CRM+1.5 CHTR+2 CDW+2 CCI+1.1 CCIV+1.5 CMS+
...
# DASH+0.7 DCBO.TO DND.TO DHIL+0.6 DLHC DKNG+ DDOG+1.7 DOC+0.7 DOL.TO+ DND.TO+ DIS+ DHR+++ DTE+ DE++ DOCU+3.8 DVN. DAL. DLR+ DTE+ DOC.V+2 DYNF+1.0 DLR+1.0
...
yahooStockOption: YahooStockOption = YahooStockOption('SNOW')#'ESTC')XWEB DDOG BEKE GBTC IHI GC=F JPY=X JPY=X ^TNX BTC-USD BTCC-B.TO
#exit(-11)
