...
# AMD+21.7 AM+0.3 AMP+1.5 AMT+1.5 AMAT+3.2 A+1.8 AA+0.5 API+1.0
...
# HD+ HLT HQU HZU HEO.V HII. HLF.TO. HUBS+3 HRL. HTA. HIW. HACK++ HRL. HXQ.TO+1.6 HCLN.TO+0.9 HERO.TO+1.5
...
# MDLZ. MDB+6 MAA. MTUM+ NWC.TO. MGNI+ MLPX+0.5 MPW+1.5 MRK+ MARA+0.5 MRNA+4 MFC.TO+0.8 MG.TO+ MOGO+1.8 MSTR+3.3 MAC+0.1
...
# PTON+4.4 PTGX+1.1 PYPL+4.1 PKI.TO+1.2
...
# TRMB+1.8 TRP&TO+0.7 TRIT+0.5 TRUL.CN+4 TROW+1.3 TSLA+13.8 TSN+0.6 TSM+3.2 TTCF+1.9 TTD+15.8 TVE.TO+0.2 TWLO+7.6 TWST+7.9 TXN+1.8 TCL-A.TO+0.7
...
yahooStockOption: YahooStockOption = YahooStockOption('ZIM')#'ESTC')XWEB DDOG BEKE GBTC IHI GC=F JPY=X JPY=X ^TNX BTC-USD BTCC-B.TO
#exit(-11)
