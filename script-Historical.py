...
yahooStockOption: YahooStockOption = YahooStockOption('LSPD.TO')#'ESTC')XWEB DDOG BEKE GBTC GNDP.V IHI
...
# AAPL+3 ABBV+ AAOI ADBE+3 ABR+ ABT++ ABX.TO&GOLD ACES ADC+ ADP+ AGNC AKAM AMGN AMD+20 AM. AMP+1.5 AMT+1.5 AMAT+3 AMZN+3 ANTM+ AQN+ AQN.TO+
# ARKK+++ ARKF++ ARKG+ ARKQ ARKW++++ APPS+++ APPN+5 AVGO++ AA. APHA+ ASAN ARKF ARKK AVAV AVGO++ AVB AYX++ AZN AWK+ ANET+2.5
...
# CNQ.TO. CSIQ+1.5 CELH+ CM+ CMI+1.5 CPX.TO+1.5 CVA. CLH+ COLL. COUP+5 CRM+1.5 CHTR+2 CDW+2 CCI+ CCIV+1.5 CMS+
...
# EMR+ ENB&TO. ESS ESTC+ ESPO EMA.TO EMQQ+2 EL+1.5 ETSY+10 ENGH.TO+ ENPH+ EEM EQB.TO+ ELY+ ESS- EPD+ EB. ENPH+25 ET. EBAY+
# F FD.TO FF.TO FDN+1.5 FFMG FENY FIE FIS+ FIVG+ FSLR FSLY++ FSRNX FSZ FTS+ FTS.TO+ FOOD.TO FZILX FZROX FVRR FXAIX FEYE. FRT. FCEL.
# FTEC+2 FAST+1.5 FB+1.5 FRC+ FRO. FROG.
# GE. GD. GM GFI++ GIS GLD+ GLW GMF GNW GRWG GILD GBTC GAMR GSY.TO+3 GOOD+ GXC+ GOOG+2 GOOGL+2 GGG++
# HD+ HLT HQU HZU HEO.V HII. HLF.TO. HUBS+3 HRL. HTA. HIW. HACK++
# IBUY+2.5 IWFH+1.25 INTC+ INTU+2 IPO+2 IIVI+2.5 IIPR+12 INVH+ IVAC+0.8 IGV+2 IBM+0.8 IRM+ IT+ IPFF. IYW+2 IWY+1.5 ICLN++
# IVR. IEP+ IXN+2
...
# PAAS+++ PAYC+6 PBH. PDD+3 PNC+ PTGX+ PIODX+ PKI.TO+ PINS+2 PNR+ PHM++ POW.TO+0.8
# QCOM+2 QQC-f QQQ+1.5 QQQJ++ QRVO+2.5 QSR.TO+ QTEC+2
# RBA RCI+ RCI.B.TO+ REAL.TO RCL.S REGI+7.5 ROK+1.5 ROKU+10 ROP+1.5 RUN+5 RY+ RY.TO+ RYT+1.5 RIOT RHS RNG+9 RF+ RNW.TO++ RSG++ RTX.
...
# T&TO+ TD TTD+15 TDOC+10 TEC.TO TAL+ TEAM+5 TENB+ TFII+ TFII.TO+ TGT- TRMB TSLA+++ TRP TRP.TO TTD+15 TOU.TO TROW TWLO+6 TWST+
# TVE.TO. TPB+++ TPR. TSN- TSM+ TCOM. TXN+2 TTCF+2 TMO+2 TRUL.CN+5
# U UNM UNP+1.5 UPWK UNM- UDN.
# VDC VFC VFF VFV.TO VG+1.5 VGT+2 VMW VNR VPL VPU VITAX+2 VTSAX+1.2 VYM VYMI VZ+ V+1.5 VOO+ VOOG+ VNQ+ VIOO VHT VSP.TO VEQT.TO+
# VGRO.TO+ VEEV+6 VTV+
