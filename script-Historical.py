...
# # Uncle Jerry's promise of a casino: growth/momentum investing
# ARKK TSLA ZM RKU IBM JNJ KO
# # Uncle Bobby's cash producing building: High income investing
# IRM T NHI
# # Best 3
# DFS MSFT HD
...
# AVGO++ AVB AYX+3.3 AZN AWK+ ANET+2.5 AEM&TO+ AES+1.5 AT.TO ATZ.TO. ARKG+2.8 ARKK+3.5 ARKQ+2.4 ARKW+4.3
# ACO-X.TO! ACN++ AIVSX+ AMC. ATVI+1.5 AXP+ AON+
# BA BE+0.9 BCE BCE.TO. BNS BPY BABA+1.7 BIDU- BBBY BNTX BRK-B+ BRTXQ BNS.TO. BIP+1.4 BEP+2.5 BIP-UN.TO+1.5 BZUN+ BILI++ BEP+
# BYND+1.4 BAM-A.TO+ BMO.TO. BTI+0.4 BMY+0.5 BGS+0.6 BAND+6.2 BP+0.5 BX+1.8 BMBL+1.0 BLNK+1.1 BTBT+2.4
# CAG CAN+1.6 CAT CCA&TO. CAR.UN.TO CGNX CGO CGO.TO. CHD CHWY CL. CLX+ CM CNI CDZ.TO CSU.TO CSX CVD CMCSA COST+1.5 CP CSCO+
...
# CSH-UN.TO+0.5 CNQ&TO+0.8 CSIQ+1.0 CRUS+1.1 CURI+1.2 CWEN+1.4 CHIQ+1.6
# DASH+0.7 DCBO.TO DND.TO DHIL+0.6 DLHC DKNG+5.6 DDOG+1.7 DOC+0.7 DOL.TO+ DND.TO+ DIS+ DHR+++ DTE+ DE++ DOCU+3.8 DVN.
# DAL. DBX+0.6 DLR+ DTE+ DOC.V+2 DYNF+1.0 DLR+1.0 DM+1.0 DISCA+0.7
# EMR+1.0 ENB&TO.+0.6 ESTC+1.2 ESPO+1.6 EMA.TO+0.8 EMQQ+2.0 ED+0.6 EL+1.5 ETSY+11.9 ENGH.TO+1.2 ENPH+30.6 EEM+0.9 EQB.TO+1.3
# ELY+1.5 ESS+0.7 EBON+0.7
# EPD+0.7 EB+0.5 EBAY+1.3 ET+0.9
# F+0.6 FD.TO FF.TO FDN+1.5 FFMG FENY FIE FIS+ FIVG+ FSR+2.4 FSLR FSLY+2.0 FSRNX FSZ FTS+ FTS.TO+ FOOD.TO FZILX FZROX
# FVRR+4.1 FXAIX FEYE. FXI+0.8
# FTEC+1.8 FAST+1.5 FB+1.5 FRC+ FRO. FROG. FRT. FCEL. FCX+3 FTCH+1.3
...
# HUBS+4.9 HIMS+1.0 HQH+0.8
# IBUY+2.5 IWFH+1.3 INTC+ INE.TO+1.3 INTU+2 IPO+2 IIVI+2.5 IIPR+12 INVH+ IVAC+0.8 IGV+2 IBM+0.8 IRM+ IT+ IPFF. IYW+1.8
# IWM +1.1 IWY+1.5 ICLN+1.5 IVR+0.3 IEP+0.8 IXN+1.7 INSG+2.9 IRBO+1.3 IGM+1.7 ILMN+1.4
# JKS+0.9 JD+1.8 JNJ+0.9 JPM+1.5 JNUG+0.0 JNPR+0.6 JBHT+1.0 JKK+1.3
# KEY K KXS.TO KDP KL&TO KO! KR KMI. K.TO++ KXS.TO+ KHC. KWEB+1.5 KGRN+1.1 KURE+1.1 KWEB+1.1
# LB.TO+0.4 LMT+0.9 LNT+0.8 LOW+1.4 LSPD&TO+2 LOGI+3.9 LAND+1.3 LMND+1.7 LULU+2.7 LUV+0.7 LW+1.25 LLY+1.5 LYFT+0.5
# M+0.5 MA+2.1 MAIN+0.8 MET+0.8 MELI+6.7 MFI.TO+0.6 MILN+1.4 MO+0.5 MU+4.5 MCD+1.0 MGM MRVL MSFT+2.5 MWK+2
# MDY+ MRU.TO+ MSCI+3.2 MFC.TO+0.8 MXIM+1.5
# MDLZ. MDB+6 MAA. MTUM+ NWC.TO. MGNI+ MLPX+0.5 MPW+1.5 MRK+0.8 MARA+0.5 MRNA+4 MFC.TO+0.8 MG.TO+ MOGO+1.8 MSTR+3.3
# MAC+0.1 MC- MPLX+0.7 MMM+0.7 MMP+0.5 MARA+0.8
# NEE+1.5 NEM+1.2 NEP+1.7 NET+3.5 NKE+1.2 NSP+1.9 NEAR+0.5 NFLX+2.9 NIO+6.2 NLY+0.7 NLOK NNDM NPI NOBL+ NVEI.TO NVDA+8.2
# NOW+4.4 NRZ+0.8 NUSI+1.0 NTST+0.9 NXST+1.5 NWC.TO+0.7 NVO+0.7
# O+0.6 OTEX+1 OHI+0.9 OKTA+6.9 OKE+1.4 OCGN+0.1 OXY+0.3
...
# PTON+4.4 PTGX+1.1 PYPL+4.1 PKI.TO+1.2 PLUG+7.9 PNW+0.7 PFFA+0.8
...
# RSG+1.0 RTX+0.7 RSP+1.0 RZG+1.0 ROBT+1.2 RIOT+9.1
# SU&TO. SEM+1.6 SFM+0.4 SIS.TO+ SNA SBUX+ SHOP&TO+22.8 SPLK SPYD SJR.B SJR-B.TO SLV+0.8 SNAP+1.6 SNOW+0.8 SPOT+1.3 SOXL+11.5
# SRU.UN.TO. SPG SAP SPGI+1.9 SKLZ+1.8 SILJ+0.8
...
# TWST+7.9 TWTR+1.8 TWOU+0.9 TXN+1.8 TCL-A.TO+0.7 TLRY+0.8 THNQ+1.1
# U+1.5 UBER+1.0 UNM+0.5 UNP+1.5 UPST+3.9 UPWK+1.2 UNM+0.5 UDN+0.5 UL+0.7
...
# VNRT.L+0.9 VNQ+0.7 VOO+1.1 VOOG+1.3 VPL+0.9 VPU+0.8 VRNS+4.7 VRTX+1.3 VSP.TO+1.0 VTI+1.1 VTV+0.9 VTWG+1.2 VTSAX+1.2
# VYM+0.9 VYMI+0.8 VZ+0.7
# W+4.2 WCN&TO+1.2 WELL.TO+225.9 WEED.TO+7.5 WISH+0.9 WM+1.1 WMT+1.1 WORK+0.8 WPC+0.8 WPM+1.5 WBA+0.3 WKHS+0.9
# XEI.TO. XIT.TO+1.7 XBC.TO XOM. XWEB+ XLC+ XLK+2 XLV+ XBC.V+++ XT+1.4 XTC.TO. ZS++ XBUY+1.5 XOM+0.4
# YCBD+0.5
...
a_ticker = 'AAPL' #'ESTC')XWEB DDOG BEKE GBTC IHI GC=F JPY=X ^TNX BTC-USD BTCC-B.TO
