...
yahooStockOption: YahooStockOption = YahooStockOption('LMND')#'ESTC')XWEB
...
# EMR+ ENB ENB.TO ESS ESTC ESPO EMA.TO ET ETSY+ ENGH.TO+
...
# WCN WCN.TO+ WELL.TO WFG WMT- WORK XEI XIT XBC.TO XOM XWEB YCBD ZG ZM ZQQ ZS ZWB
