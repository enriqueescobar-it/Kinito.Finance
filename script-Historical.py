...
yahooStockOption: YahooStockOption = YahooStockOption('SHOP')
...
# M MA MAIN MELI MFI.TO MO MU MCD- MPW MRNA MRVL MSFT MWK NET NKE NSP NEAR NFLX NLY NLOK NPI NVEI.TO O+ OTEX
