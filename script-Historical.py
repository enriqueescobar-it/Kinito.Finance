...
yahooStockOption: YahooStockOption = YahooStockOption('U')
# CLX UNP PM JNJ HD AMGN PRU TROW TXN NVEI.TO IPO SNOW VMW MO
...
# GNW GRWG HQU HZU IT JNUG KEY K KDP KL KO KR LMT LSPD MA MWK NKE NPI OTEX PPL QQC-f QQQ RCI RCI.B RY
# SHOP SJR.B SOXL
# T TD TEC.TO TFII VDC VFV VGT VNR VPU VTSAX VYM VZ WCN WELL WMT XEI XIT YCBD ZM ZQQ ZWB
