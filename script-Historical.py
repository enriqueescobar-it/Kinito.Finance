...
yahooStockOption: YahooStockOption = YahooStockOption('BMY')#'ESTC')XWEB DDOG BEKE GBTC GNDP.V
# DividendYield [2%, 4%]
...
# AAPL ABBV+ AAOI ADBE+ ABR+ ABT ABX.TO&GOLD ACES ADC+ ADP AGNC AKAM AMGN AMD AMP AMT+ AMZN++ ANTM+ AQN+ AQN.TO+ ARKK+++ ARKF+ ARKG+ ARKQ ARKW++++ APPS+++
# APHA+ ASAN ARKF ARKK AVAV AVGO++ AVB AYX++ AZN AIVSX+ AEM+ AEM.TO+ AWK+ ANET+ AT.TO ATZ.TO. ACO-X.TO+ ARKG+ A++
...
# CNR.TO+ CU.TO. CSU.TO++ CTC-A.TO+ CLR.TO. CRWD++ CARR++ CB- CU.TO
# DCBO.TO DND.TO DLHC DDOG DKNG+ DDOG+ DOL.TO+ DND.TO+ DIS- DHR+++ DTE+ DE++
# EMR+ ENB- ENB.TO- ESS ESTC+ ESPO EMA.TO ET ETSY+ ENGH.TO+ ENPH+ EEM EQB.TO+ ELY+ ESS- EPD+
# F FD.TO FF.TO FFMG FENY FIE FIVG FROG FSLR FSLY+ FSRNX FSZ FTS+ FTS.TO+ FOOD.TO FZILX FZROX FVRR FXAIX FEYE- FRT-
# GM GFI++ GIS GLD GLW GMF GNW GRWG GILD GBTC GAMR GSY.TO+ GOOD GXC+ GOOG+
# HD+ HLT HQU HZU HEO.V HII. HLF.TO.
...
# M MA MAIN MELI+ MFI.TO MO- MU MCD- MGM MPW MRK+ MARA MRNA MRVL MSFT+ MWK MDY MRU.TO MSCI+ NXST MFC.TO. MXIM+ NWC.TO. MDLZ.
# NEE+ NEM+ NET++ NKE NSP NEAR NFLX+++ NIO++ NLY NLOK NNDM NPI NOBL+ NVEI.TO NVDA+++++ NOW+ NRZ-
# O+ OTEX OHI O- NWC.TO. OKTA+++++ OKE++ MC-
# PM- PANW PFE PINS PGX PEP PLAN PLTR PPL PRU- PVD PTON PAWZ PSEC PYPL PCTY+++ PKI.TO PIODX+ PKI.TO+ PINS+ PHO PHM++ POW.TO. PAAS+++
# QCOM QQC-f QQQ QRVO QSR.TO+ RBA RCI+ RCI.B.TO+ REAL.TO REGI ROK+ RUN RY+ RY.TO+ RCI.B.TO. RIOT RHS QRS.TO REAL.TO ROKU+ RF+
# SU SU.TO. SIS.TO+ SNA SBUX SHOP+ SHOP.TO+ SPLK SPYD SJR.B SJR-B.TO SLV SNAP SNOW+ SPOT SOXL SRU.UN.TO. SPG SAP SPNS STOR+
# STAG SEDG+ SJR-B.TO SOY.TO. SYK++ STX+
# T+ T.TO+ TD TDOC+ TEC.TO TAL+ TEAM TFII+ TFII.TO+ TGT- TRMB TSLA+++ TRP TRP.TO TTD+++++ TOU.TO TROW TWLO++++ TXN TWST+ TVE.TO. TPB+++ TSN- TSM+
# U UNM UNP UPWK UNM-
# VDC VFC VFF VFV.TO VGT VMW VNR VPL VPU VTSAX VYM VYMI VZ+ V VOO+ VOOG+ VNQ+ VIOO VHT VSP.TO VEQT.TO+ VGRO.TO+
# WCN WCN.TO+ WELL.TO WEED.TO++ WFG WMT- WORK. WPC- XEI XIT XBC.TO XOM. XWEB+ XLK+ XBC.V+++ ZS++ YCBD ZG ZM+++ ZQQ ZS ZWB
