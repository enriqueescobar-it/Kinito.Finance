...
yahooStockOption: YahooStockOption = YahooStockOption('XEI.TO')#'ESTC')XWEB DDOG BEKE GBTC GNDP.V
...
# M MA+2 MAIN MELI+ MFI.TO MO- MU+3 MCD- MGM MPW MRK+ MARA MRNA MRVL MSFT+ MWK MDY MRU.TO+ MSCI+ NXST MFC.TO. MXIM+ NWC.TO.
# MDLZ. MDB+6 MAA.
# NEE+ NEM+ NET+2 NKE NSP NEAR NFLX+++ NIO+4 NLY. NLOK NNDM NPI NOBL+ NVEI.TO NVDA+++++ NOW+ NRZ-
# O+ OTEX OHI O- NWC.TO. OKTA+++++ OKE++ MC-
# PM- PANW PFE PINS PGX PEP PLAN PLTR PPL.TO+ PBA+ PRU- PVD PTON PAWZ PSEC PYPL+3 PCTY+++ PKI.TO PIODX+ PKI.TO+ PINS+ PHO PHM++ POW.TO.
...
# SPNS+2 SNPS+3 STOR+ STAG SEDG+ SJR-B.TO SOY.TO. SYK++ STX+ SQ+8 SFTBY+2
# T+ T.TO+ TD TDOC+ TEC.TO TAL+ TEAM TFII+ TFII.TO+ TGT- TRMB TSLA+++ TRP TRP.TO TTD+15 TOU.TO TROW TWLO+6 TXN TWST+
# TVE.TO. TPB+++ TSN- TSM+
# U UNM UNP UPWK UNM-
# VDC VFC VFF VFV.TO VGT VMW VNR VPL VPU VTSAX VYM VYMI VZ+ V VOO+ VOOG+ VNQ+ VIOO VHT VSP.TO VEQT.TO+ VGRO.TO+ VEEV+6
