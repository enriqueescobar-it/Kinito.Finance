...
yahooStockOption: YahooStockOption = YahooStockOption('BABA')#'ESTC')XWEB DDOG BEKE GBTC GNDP.V
# DividendYield [2%, 4%]
...
# AAPL ABBV+ AAOI ADBE+ ABR+ ABT ABX.TO&GOLD ACES ADC+ ADP AGNC AKAM AMGN AMD AMP AMT+ AMZN++ ANTM+ AQN+ AQN.TO+
# ARKK+++ ARKF++ ARKG+ ARKQ ARKW++++ APPS+++ APPN+5 AVGO++
...
# DCBO.TO DND.TO DLHC DDOG DKNG+ DDOG+ DOL.TO+ DND.TO+ DIS- DHR+++ DTE+ DE++ DOCU+3 DVN.
...
# PM- PANW PFE PINS PGX PEP PLAN PLTR PPL PRU- PVD PTON PAWZ PSEC PYPL PCTY+++ PKI.TO PIODX+ PKI.TO+ PINS+ PHO PHM++ POW.TO.
# PAAS+++ PAYC+6 PBH. PDD+3
...
# WCN WCN.TO+ WELL.TO WEED.TO++ WFG WMT- WORK. WPC- XEI XIT XBC.TO XOM. XWEB+ XLK+ XBC.V+++ XTC.TO. ZS++
# YCBD
