...
yahooStockOption: YahooStockOption = YahooStockOption('DOCU')#'ESTC')XWEB DDOG BEKE GBTC GNDP.V
# DividendYield [2%, 4%]
...
# ARKK+++ ARKF+ ARKG+ ARKQ ARKW++++ APPS+++ APPN+5
...
# CNR.TO+ CU.TO. CSU.TO++ CTC-A.TO+ CLR.TO. CRWD++ CARR++ CB- CU.TO. CRSP++++++ C.
# DCBO.TO DND.TO DLHC DDOG DKNG+ DDOG+ DOL.TO+ DND.TO+ DIS- DHR+++ DTE+ DE++ DOCU+3
# EMR+ ENB- ENB.TO- ESS ESTC+ ESPO EMA.TO ET ETSY+10 ENGH.TO+ ENPH+ EEM EQB.TO+ ELY+ ESS- EPD+ EB.
