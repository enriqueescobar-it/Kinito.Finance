...
yahooStockOption: YahooStockOption = YahooStockOption('NXST')#'ESTC')XWEB DDOG BEKE GBTC GNDP.V IHI
...
# IBUY+2.5 IWFH+1.25 INTC+ INTU+2 IPO+2 IIVI+2.5 IIPR+12 INVH+ IVAC+0.8 IGV+ IBM+.5 IRM+ IT+ IPFF. IWY++ ICLN++ IVR. IEP+
...
# M+0.5 MA+2 MAIN+0.8 MET+0.8 MELI+10 MFI.TO MO. MU+3 MCD+ MGM MPW+1.5 MRK+ MARA+0.5 MRNA+4 MRVL MSFT+2.5 MWK+2 MDY+ MRU.TO+ MSCI+ MFC.TO. MXIM+
# MDLZ. MDB+6 MAA. MTUM+ NWC.TO. MGNI+ MLPX+0.5
