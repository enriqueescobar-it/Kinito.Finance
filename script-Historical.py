...
yahooStockOption: YahooStockOption = YahooStockOption('RDS-B')
...
# M MA MAIN MELI MFI.TO MO MU MCD- MPW MRNA MRVL MSFT MWK MDY
# NEM+ NET NKE NSP NEAR NFLX NLY NLOK NPI NVEI.TO O+ OTEX
