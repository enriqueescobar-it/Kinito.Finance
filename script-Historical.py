...
yahooStockOption: YahooStockOption = YahooStockOption('VOOG')#'ESTC')XWEB DDOG BEKE GBTC GNDP.V
...
# CNQ.TO CSIQ CELH+ CM+ CPX.TO++ CVA. CLH+ COLL.
# CNR.TO+ CU.TO. CSU.TO++ CTC-A.TO+ CLR.TO. CRWD++ CARR++ CB- CU.TO. CRSP++++++ C. CLNE. CMCSA+ CIBR+
# DCBO.TO DND.TO DLHC DDOG DKNG+ DDOG+ DOL.TO+ DND.TO+ DIS- DHR+++ DTE+ DE++ DOCU+3 DVN. DAL. DLR+ DTE+
...
# PAAS+++ PAYC+6 PBH. PDD+3 PNC+ PTGX+
...
# SPNS+2 SNPS+3 STOR+ STAG SEDG+ SJR-B.TO SOY.TO. SYK++ STX+ SQ+8 SFTBY+2 SAVA.
