...
import quandl
# ### Make a Basic Data Call # This call gets the WTI Crude Oil price from the US Department of Energy:
...
# ### Change Formats # You can get the same data in a NumPy array:
