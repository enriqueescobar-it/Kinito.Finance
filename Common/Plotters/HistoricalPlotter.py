...
class HistoricalPlotter(AbstractPlotter):
    ...
    def Plot(self):
        ...
        plt.axhline(self.__yeAverage200, linestyle='-.', label='yeAverage200=' + str(self.__yeAverage200), alpha=0.50, color='orange')
        plt.axhline(self.__yeAverage50, linestyle='-.', label='yeAverage50=' + str(self.__yeAverage50), alpha=0.50, color='yellow')
