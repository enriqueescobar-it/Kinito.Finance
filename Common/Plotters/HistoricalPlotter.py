...
class HistoricalPlotter(AbstractPlotter):
    ...
    def __init__(self, stock_option: YahooStockOption):
        ...
        self._dataWeeklyCum = stock_option.SimpleWeeklyCum
        self._dataMonthly = stock_option.SimpleMonthly
        self._dataMonthlyCum = stock_option.SimpleMonthlyCum
        ...
        self._mean = np.mean(stock_option.HistoricalData[self._col])
        ...
        self._std = np.std(stock_option.HistoricalData[self._col])
    ...
    def _getDataPlot(self, ax: object):
        ...
        mean_label: str = self._col + '_Mean=' + str(self._mean)
