...
class HistoricalPlotter(AbstractPlotter):
    ...
    def Plot(self):
        ...
        plt.axhline(self.__yeHigh52, linestyle='--', label='yeHigh52', alpha=0.50, color='red')
        plt.axhline(self.__yeLow52, linestyle='--', label='yeLow52', alpha=0.50, color='green')
        plt.axhline(self.__yeAverage200, linestyle='-.', label='yeAverage200', alpha=0.50, color='orange')
        plt.axhline(self.__yeAverage50, linestyle='-.', label='yeAverage50', alpha=0.50, color='yellow')
