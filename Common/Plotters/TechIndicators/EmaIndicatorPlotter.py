...
class EmaIndicatorPlotter(AbstractTechIndicatorPlotter):
    ...
    def Plot(self):
        ...
        plt.plot(self.__DATE_TIME_INDEX, self.__ABSTRACT_INDICATOR._EMA05, label=self.__TICKER_LABEL + '05', alpha=0.50, color='lightblue')
        plt.plot(self.__DATE_TIME_INDEX, self.__ABSTRACT_INDICATOR._EMA21, label=self.__TICKER_LABEL + '21', alpha=0.50, color='lightgray')
        plt.plot(self.__DATE_TIME_INDEX, self.__ABSTRACT_INDICATOR._EMA63, label=self.__TICKER_LABEL + '63', alpha=0.50, color='green')
