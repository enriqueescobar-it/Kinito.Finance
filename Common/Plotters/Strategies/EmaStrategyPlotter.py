...
class EmaStrategyPlotter(AbstractStrategyPlotter):
    ...
    def Plot(self):
        ...
        plt.plot(self.__STRATEGY_DATA_FRAME[self.__STRATEGY_LABEL + '21'], label=self.__STRATEGY_LABEL + '21', alpha=0.50, color='orange')
        plt.plot(self.__STRATEGY_DATA_FRAME[self.__STRATEGY_LABEL + '63'], label=self.__STRATEGY_LABEL + '63', alpha=0.50, color='violet')
